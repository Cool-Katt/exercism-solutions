...
private immutable auto ANSWERS = ["Whatever.", "Sure.", "Whoa, chill out!", "Calm down, I know what I'm doing!"];

@safe pure string hey(string remark) {
    auto sentence = remark.strip;
    if (sentence.empty) return "Fine. Be that way!";

    auto isQuestion = sentence.endsWith("?") ? 1 : 0;
    auto isShout = sentence.any!isAlpha && sentence == sentence.toUpper ? 2 : 0;
